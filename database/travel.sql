...
--
-- Host: localhost
-- Generation Time: Jul 17, 2018 at 04:07 PM
...
(13, 1, 'jijin mohan', 'Male', '9895235625', 'jijinsrm@gmail.com', 3, 2, 2, 'fghgh', 'Pending');
...
CREATE TABLE IF NOT EXISTS `map` (
  ...
  `pl_lat` varchar(250) NOT NULL,
  `pl_lon` varchar(250) NOT NULL,
  PRIMARY KEY (`pl_id`)
...
INSERT INTO `map` (`pl_id`, `pl_name`, `pl_lat`, `pl_lon`) VALUES
(1, 'Dublin', '53.3498', '6.2603');
